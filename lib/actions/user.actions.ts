...
const {
    ...
    APPWRITE_USER_COLLECTION_ID: USER_TABLE_ID,
    APPWRITE_BANK_COLLECTION_ID: BANK_TABLE_ID
...
export const signUp = async (userData: SignUpParams) => {
    ...
    try {
        ...
        newUserAccount = await account.create({ userId: String(ID.unique()), email, password, name })
...
export const exchangePublicToken = async ({
    ...
    try {
        ...
        // Create a funding source URl for hte account using the Dwolla customer ID, processor token, and bank name.
